package com.groupseven.voicestamp.mainlist.views;
...
public class BubbleProgressView extends View {
    ...
    private void init() {
        ...
        mColorProgressBg = getResources().getColor(R.color.progressBg);
        mColorProgress = getResources().getColor(R.color.progressCover);
